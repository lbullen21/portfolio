        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {["Next.js", "TypeScript", "OpenWeather API", "Google Maps API"].map((tech) => (
                      <span
                        key={tech}
                        className="px-4 py-2 bg-sky-100/60 dark:bg-sky-900/30 text-sky-800/80 dark:text-sky-300 text-sm font-medium rounded-lg"
                      >
                        {tech}
                      </span>
                    ))}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 flex flex-col">
              {/* Project Hero */}
              <div className="bg-gradient-to-br from-emerald-400 via-teal-500 to-blue-600 h-64 flex items-center justify-center">
                <div className="text-white text-center">
                  <svg
                    className="w-20 h-20 mx-auto mb-4"
                    fill="none"
                  ...
                  <h3 className="text-2xl font-bold">PlanIT</h3>
                  <p className="text-lg opacity-90">Trip planning made simple</p>
                </div>
              </div>
              ...
              <div className="p-8 flex-1 flex flex-col">
                <div className="mb-6">
                  <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">
                    PlanIT Trip Planning
                  </h3>
                  
                  <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                    A trip planning application that helps users create detailed 
                    itineraries for upcoming travel plans.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-4 mt-auto">
                  <a
                    href="https://trip-planner-lp.vercel.app/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center px-6 py-3 bg-cyan-500/80 hover:bg-cyan-600/80 text-white font-medium rounded-lg transition-colors duration-200"
                  >
                  ...
                  <a
                    href="https://github.com/lbullen21/trip-planner"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center px-6 py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200"
                  >
